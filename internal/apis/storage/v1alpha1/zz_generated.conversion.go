...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*storagev1alpha1.OSDataSource)(nil), (*storage.OSDataSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_OSDataSource_To_storage_OSDataSource(a.(*storagev1alpha1.OSDataSource), b.(*storage.OSDataSource), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*storage.OSDataSource)(nil), (*storagev1alpha1.OSDataSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_storage_OSDataSource_To_v1alpha1_OSDataSource(a.(*storage.OSDataSource), b.(*storagev1alpha1.OSDataSource), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_OSDataSource_To_storage_OSDataSource is an autogenerated conversion function.
func Convert_v1alpha1_OSDataSource_To_storage_OSDataSource(in *storagev1alpha1.OSDataSource, out *storage.OSDataSource, s conversion.Scope) error {
	return autoConvert_v1alpha1_OSDataSource_To_storage_OSDataSource(in, out, s)
}
...
// Convert_storage_OSDataSource_To_v1alpha1_OSDataSource is an autogenerated conversion function.
func Convert_storage_OSDataSource_To_v1alpha1_OSDataSource(in *storage.OSDataSource, out *storagev1alpha1.OSDataSource, s conversion.Scope) error {
	return autoConvert_storage_OSDataSource_To_v1alpha1_OSDataSource(in, out, s)
}
