...
type NetworkPolicyIndexInformer cache.TypedSharedIndexInformer[*apinetworkingv1alpha1.NetworkPolicy]

// NetworkPolicyHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for NetworkPolicy.
type NetworkPolicyHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apinetworkingv1alpha1.NetworkPolicy]

// NetworkPolicyDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for NetworkPolicy.
type NetworkPolicyDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apinetworkingv1alpha1.NetworkPolicy]

// NetworkPolicyFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for NetworkPolicy.
type NetworkPolicyFilteringHandler = cache.TypedFilteringResourceEventHandler[*apinetworkingv1alpha1.NetworkPolicy]

// NetworkPolicyIndexers is a specialization of [cache.TypedIndexers] for NetworkPolicy.
type NetworkPolicyIndexers = cache.TypedIndexers[*apinetworkingv1alpha1.NetworkPolicy]

// DeletedNetworkPolicy is a specialization of [cache.DeletedObject] for NetworkPolicy.
type DeletedNetworkPolicy = cache.DeletedObject[*apinetworkingv1alpha1.NetworkPolicy]
...
func NewTypedNetworkPolicyInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) NetworkPolicyIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apinetworkingv1alpha1.NetworkPolicy](cache.NewSharedIndexInformerWithOptions(
...
func (f *networkPolicyInformer) TypedInformer() NetworkPolicyIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apinetworkingv1alpha1.NetworkPolicy](f.factory.InformerFor(&apinetworkingv1alpha1.NetworkPolicy{}, f.defaultInformer))
}
...
func (a *networkPolicyTypedInformerAdapter) TypedInformer() NetworkPolicyIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apinetworkingv1alpha1.NetworkPolicy](a.Informer())
}
...
func ToNetworkPolicyIndexInformer(informer cache.SharedIndexInformer) NetworkPolicyIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apinetworkingv1alpha1.NetworkPolicy](informer)
}
